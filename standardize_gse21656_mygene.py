...
input_file = os.path.join(base_path, "standard", "GSE21656", "GSE21656_DEGS_significativos.csv")
output_file = os.path.join(base_path, "standard", "GSE21656", "GSE21656_DEGS_significativos_standard.csv")
